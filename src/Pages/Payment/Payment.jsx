...
function Payment() {
  ...
  const handlePayment = async (event) => {
    ...
    try {
      setProcessing(true);
      const totalAmount = totalItem * 100; // Total amount in cents
      console.log("Total Amount being sent:", totalAmount); // Log total amount

      const response = await axiosInstance({
        method: "POST",
        url: `/payment/create?total=${totalAmount}`,
      });
